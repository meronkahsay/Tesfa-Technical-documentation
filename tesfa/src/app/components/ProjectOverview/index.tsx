...
export default function ProjectOverview() {
  return (
    <div className="bg-white flex flex-col mt-25  px-6 py-12">
   
      <h2 className="text-3xl md:text-6xl  px-35 font-bold  text-[#003D3B]">
        Project Overview
      </h2>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3  items-center justify-center gap-10 md:px-15 w-full">
        ...
        <div className="flex flex-col">
          ...
          <h3 className="mt-10 ml-22 text-xl  md:text-3xl font-semibold text-[#C59D2C]">
            Organization Dashboard
          </h3>
          <p className="mt-10 ml-22 md:text-xl text-sm text-[#003D3B] leading-relaxed">
        ...
        <div className="flex flex-col ">
          ...
          <h3 className="mt-10 text-xl ml-22  md:text-3xl font-semibold text-[#C59D2C]">
            Informational Website
          </h3>
          <p className="mt-10 md:text-xl ml-22 text-sm text-[#003D3B] leading-relaxed">
