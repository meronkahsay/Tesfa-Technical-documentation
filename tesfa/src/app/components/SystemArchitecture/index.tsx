export default function SystemArchitecture() {
  return (
    <section id="system-architecture" className="w-full px-6 md:px-40 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-55 mb-35">
        ...
        <div className="space-y-15 text-2xl">
          <div>
            ...
            <p className="text-[#003333] mt-4 ml-4">
