export default function TestingQA() {
  return (
    <div id="testing" className="min-h-screen mt-20  flex flex-col items-center justify-center py-10">
      ...
      <div className="bg-[#004240] mt-15">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 w-full  lg:px-50 lg:py-20">
          ...
          <div className="bg-[#004240] md:mb-45 text-white   p-15 px-7  border-t-2 border-l-2 border-r-2 border-dashed border-[#C59D2C] py-10">
          ...
          <div className="bg-[#004240] text-white md:mt-45  px-7 p-12 border-b-2 border-l-2 border-r-2 border-dashed border-[#C59D2C] py-10">
          ...
          <div className="bg-[#004240] md:mb-45 text-white  px-7  border-t-2 border-l-2 border-r-2 border-dashed border-[#C59D2C] py-10">
