       ...
       <div className="flex flex-col gap-8">
         ...
         <section className="bg-[#B88704] text-white xl:w-160 rounded-md border border-[#B88704] p-8 shadow-md">
           ...
           <ul className="list-disc pl-6 mb-4 space-y-1 md:text-xl text-base">
             ...
             <li>
               Uses React hooks (<span className="font-mono">useState</span>, <span className="font-mono">useEffect</span>, <span className="font-mono">useMemo</span>).
             </li>
             <li>
               Custom hooks are in <span className="font-mono">hooks/</span> and follow the <span className="font-mono">useX</span> naming convention.
             </li>
             <li>
               File/folder naming is <span className="font-mono">camelCase</span> (<span className="italic">shared-components/Header/index.js</span>).
             </li>
           </ul>
           ...
           <ul className="list-disc pl-6 mb-4 space-y-1 md:text-xl text-base">
             ...
             <li>
               Components: <span className="font-mono">PascalCase</span> (<span className="italic">LoginPage, ProductsIndex</span>)
             </li>
             <li>
               Variables: <span className="font-mono">camelCase</span> (<span className="italic">sidebarOpen, showModal</span>)
             </li>
           </ul>
         ...
         <section className="bg-yellow-50 text-[#B88704] rounded-md border border-[#B88704] p-8 shadow-md">
           ...
           <ul className="list-disc pl-6 mb-4 md:text-xl space-y-1 text-base">
             ...
             <li>Classes: <span className="font-mono">PascalCase</span> (if present)</li>
